...
This reference is generated from the exact MCP schemas registered by the Go server. For routed tools, it also records the extension capability and permissions enforced by the production path.
