...
var browserToolLevels = map[string]toolProfileLevel{
	...
	"browser_search_history":            toolProfileFull,
	"browser_get_history_visits":        toolProfileFull,
	"browser_delete_history_url":        toolProfileFull,
	"browser_delete_history_range":      toolProfileFull,
	"browser_clear_history":             toolProfileFull,
	"browser_list_bookmarks":            toolProfileFull,
	"browser_create_bookmark":           toolProfileFull,
	"browser_update_bookmark":           toolProfileFull,
	"browser_move_bookmark":             toolProfileFull,
	"browser_remove_bookmark":           toolProfileFull,
	"browser_list_reading_list":         toolProfileFull,
	"browser_add_reading_list_entry":    toolProfileFull,
	"browser_update_reading_list_entry": toolProfileFull,
	"browser_remove_reading_list_entry": toolProfileFull,
