		...
		if _, err := browserRegistry.Register(
			registry.Registration{
				...
				Capabilities: []string{
					...
					protocol.CommandStorageList,
					protocol.CommandStorageListSensitive,
					protocol.CommandStorageGet,
					protocol.CommandStorageGetSensitive,
					protocol.CommandStorageSet,
					protocol.CommandStorageRemove,
					protocol.CommandStorageCacheMetadata,
					protocol.CommandStorageIndexedDBMetadata,
					protocol.CommandStorageClear,
					protocol.CommandDownloadsList,
					protocol.CommandDownloadsGet,
					protocol.CommandDownloadsCreate,
					protocol.CommandDownloadsPause,
					protocol.CommandDownloadsResume,
					protocol.CommandDownloadsCancel,
					protocol.CommandDownloadsErase,
					protocol.CommandHistorySearch,
					protocol.CommandHistoryGetVisits,
					protocol.CommandHistoryDeleteURL,
					protocol.CommandHistoryDeleteRange,
					protocol.CommandHistoryDeleteAll,
					protocol.CommandBookmarksList,
					protocol.CommandBookmarksCreate,
					protocol.CommandBookmarksUpdate,
					protocol.CommandBookmarksMove,
					protocol.CommandBookmarksRemove,
					protocol.CommandReadingListList,
					protocol.CommandReadingListAdd,
					protocol.CommandReadingListUpdate,
					protocol.CommandReadingListRemove,
